...
The full C ABI specification is available at [C ABI Specification](reference-ffi-abi).
...
- [C ABI Specification](reference-ffi-abi) — Complete type definitions, return codes, memory ownership rules, and threading model
