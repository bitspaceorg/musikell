...
- Familiarity with the [First Program](guide-first-program) example
...
- [Nodes](guide-nodes) -- detailed guide to all three node types
- [Routing](guide-routing) -- inputs, outputs, groups, and feedback
