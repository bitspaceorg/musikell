...
- [Concepts](guide-concepts) -- understanding of nodes, edges, and the graph model
...
See [Patterns](guide-patterns) for full sequencer documentation.
...
See [Conditional](guide-conditional) for advanced routing patterns.
...
- [Routing](guide-routing) -- inputs, outputs, groups, and feedback edges
- [Effects](guide-effects) -- detailed guide to filter, delay, reverb, and dynamics kernels
