...
- [Nodes](guide-nodes) -- understanding of the three node types
- [Routing](guide-routing) -- understanding of signal flow
...
- [Stereo](guide-stereo) -- channels, .L/.R access, mono-to-stereo
- [Examples](guide-examples) -- complete programs using conditional routing
